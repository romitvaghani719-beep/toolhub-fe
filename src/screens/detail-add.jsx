...
import {
  CATEGORIES, TOOLS, catColor, catName, memberColor, memberName, toolById,
} from "../data.js";
import {
  Avatar, CapBadges, Icon, LogoTile, PageHeader, Toggle, ToolCard, Upvote,
} from "../components.jsx";

/* ---------------- TOOL DETAIL ---------------- */
export function DetailScreen({ nav, toolId, votes, onVote }) {
...
export function AddToolScreen({ nav }) {
