...
import {
  ACTIVITY, CATEGORIES, MEMBERS, TOOLS, catColor, catName,
  memberColor, memberName, toolById,
} from "../data.js";
import {
  Avatar, Icon, LogoTile, PageHeader, SearchInput,
} from "../components.jsx";

/* ---------------- DAILY ACTIVITY ---------------- */
export function ActivityScreen({ nav }) {
