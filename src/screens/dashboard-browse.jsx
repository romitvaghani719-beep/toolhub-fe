...
import {
  CATEGORIES, TOOLS, catName, memberName,
} from "../data.js";
import {
  Avatar, CheckRow, Icon, LogoTile, PageHeader, SearchInput,
  StatCard, ToolCard, Upvote,
} from "../components.jsx";

/* ---------------- DASHBOARD ---------------- */
export function DashboardScreen({ nav, votes, onVote }) {
...
/* ---------------- BROWSE ---------------- */
export function BrowseScreen({ nav, votes, onVote }) {
